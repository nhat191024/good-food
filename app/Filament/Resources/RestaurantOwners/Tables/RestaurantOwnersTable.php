...
namespace App\Filament\Resources\RestaurantOwners\Tables;
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('verify')
                    ...
                    ->modalHeading(fn ($record): string => $record->is_verified ? 'Hủy xác minh chủ nhà hàng' : 'Xác minh chủ nhà hàng')
                    ->modalDescription(fn ($record): string => $record->is_verified
                        ? 'Bạn có chắc chắn muốn hủy xác minh chủ nhà hàng này không?'
                        : 'Bạn có chắc chắn muốn xác minh chủ nhà hàng này không?')
