        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('verify')
                    ...
                    ->modalHeading(fn ($record): string => $record->is_verified ? 'Hủy xác minh tài xế' : 'Xác minh tài xế')
                    ->modalDescription(fn ($record): string => $record->is_verified
                        ? 'Bạn có chắc chắn muốn hủy xác minh tài xế này không?'
                        : 'Bạn có chắc chắn muốn xác minh tài xế này không?')
